package it.south.dev.skillator.config.timezone;

import it.south.dev.skillator.SkillatorApp;
import it.south.dev.skillator.repository.timezone.DateTimeWrapper;
import it.south.dev.skillator.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = SkillatorApp.class)
